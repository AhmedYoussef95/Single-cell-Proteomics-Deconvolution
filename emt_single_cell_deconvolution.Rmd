...
```{r correlationOfClusterTightnessToError, fig.width = 12, fig.height = 8, out.width = '.49\\linewidth', fig.align = 'center', fig.show = 'hold'}
...
```
#### How does the optimal regression parameter change for different categories of genes?

We group the genes according to how variable they are across clusters and compute and compare the optimal regression parameter for each of the groups.

```{r lambdaChangesInValue}
