...
2) ***Reconstructed Pseudo-bulk***: The reconstructed pseudo-bulk is created by matrix multiplication of the average cell cluster abundance of each protein and the number of cells in each cluster in each timepoint, i.e. $Y = AX$.
