...
geneLambdas <- geneLambdas %>% 
  ...
  mutate(Number_of_clusters = paste(Number_of_clusters, "clusters"))
...
In this section of the report, we focus on deconvoluting the bulk proteomics data with 11 Seurat-defined clusters. We furthermore focus a set of 80 hallmark genes associated with EMT from the [MSigDB database](https://www.gsea-msigdb.org/gsea/msigdb/cards/HALLMARK_EPITHELIAL_MESENCHYMAL_TRANSITION.html). 

```{r deconvoluteProteomics}
